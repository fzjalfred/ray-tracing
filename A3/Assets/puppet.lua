...
torso_g = gr.mesh('sphere', 'torso_g')
shoulders_g = gr.mesh('sphere', 'shoulders_g')
neck_g = gr.mesh('sphere', 'neck_g')
head_g = gr.mesh('sphere', 'head_g')
left_eye_g = gr.mesh('sphere', 'left_eye_g')
right_eye_g = gr.mesh('sphere', 'right_eye_g')

leftUpperArm_g = gr.mesh('sphere', 'leftUpperArm_g')
rightUpperArm_g = gr.mesh('sphere', 'rightUpperArm_g')
leftForearm_g = gr.mesh('sphere', 'leftForearm_g')
rightForearm_g = gr.mesh('sphere', 'rightForearm_g')
leftHand_g = gr.mesh('sphere', 'leftHand_g')
rightHand_g = gr.mesh('sphere', 'rightHand_g')

hips_g = gr.mesh('sphere', 'hips_g')
leftThigh_g = gr.mesh('sphere', 'leftThigh_g')
rightThigh_g = gr.mesh('sphere', 'rightThigh_g')
leftCalf_g = gr.mesh('sphere', 'leftCalf_g')
rightCalf_g = gr.mesh('sphere', 'rightCalf_g')
leftFoot_g = gr.mesh('sphere', 'leftFoot_g')
rightFoot_g = gr.mesh('sphere', 'rightFoot_g')
